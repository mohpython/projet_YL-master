...
<!-- NAVIGATION -->
	<header>
		<div class="nav" id="nav">
			...
			<div class="switch-tab" id="switch-tab" onclick="switchTAB()"><img src="../images/icon/pn.png"></div>
			<ul id="list-switch">
				<li><a href="formation.php"><img src="../images/courses/d1.png" class="icon"> la Sciences</a></li>
...
<!-- MAIN Heading of Page -->
	<div class="title" id="title">
		<span>Testez vos connaissance</span>
		<div class="shortdesc"><br>
			<p>Si vous pensez que l'éducation coûte cher, essayez l'ignorance</p>
		</div>
