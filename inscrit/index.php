    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          ...
          <div class="logo"><a href="http://localhost:8000/index.php"><img src="assets/img/logo/logg.png" alt="logo"></div></a>
                ...
                <div class="container <?php echo (isset($_GET['errorp']) || isset($_GET['signup']))? 'right-panel-active':''; ?>" id="container">
                  <div class="form-container sign-up-container">
                    <form action="includes/signup1.inc.php" method="post" id="signup_form">
                      ...
                      <input type="text" id="name_signup" name="uid" placeholder="Nom et prenom" value="<?php if (isset($_GET['errorp'])){
                  ...
                  <div class="form-container sign-in-container">
                    <form action="includes/login.inc.php" method="post" id="signin_form">
                      ...
                      <a href="moroco.html"><button>SeConnecter</button></a>
                    </form>
                  </div>
